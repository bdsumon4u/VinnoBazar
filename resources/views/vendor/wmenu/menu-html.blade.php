                                        ...
                                        <form id="nav-menu-meta" action="" class="nav-menu-meta" method="post"
                                            ...
                                            <div id="side-sortables" class="accordion-container">
                                                <ul class="outer-border">
                                                                        ...
                                                                        @foreach ($categories as $category)
                                                                            <div class="custom-control custom-checkbox">
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    data-link="{{ url('category/' . $category->categorySlug) }}"
                                                                                    id="customCheck{{ $category->id }}">
                                                                                <label class="custom-control-label"
                                                                                    for="customCheck{{ $category->id }}">{{ $category->categoryName }}</label>
                                                                            </div>
                                                                        @endforeach
                                                                        <br>
                                                                    </div>
                                                    ...
                                                    <li class="control-section accordion-section  add-page"
                                                        id="add-page">
                                                        <h3 class="accordion-section-title hndle" tabindex="0"> Page
                                                            Link <span class="screen-reader-text">Press return or enter
                                                                to expand</span></h3>
                                                        <div class="accordion-section-content ">
                                                            <div class="inside">
                                                                        ...
                                                                        @foreach ($pages as $page)
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    data-link="{{ url('page/' . $page->pageSlug) }}"
                                                                                    id="page{{ $page->id }}">
                                                                                <label class="custom-control-label"
                                                                                    for="page{{ $page->id }}">{{ $page->pageTitle }}</label>
                                                                            </div>
                                                                        @endforeach
                                                                        <br>
                                                                    </div>
