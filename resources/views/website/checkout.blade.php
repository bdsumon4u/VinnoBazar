                    ...
                    <div class="col-md-6">
                        <aside class="card mb-4">
                            <article class="card-body">
                                <header class="mb-4">
                                    <p class="text-center" style="font-size: 20px;"> <span class="text-danger">শতভাগ নিশ্চিত
                                            হয়ে অর্ডার কনফার্ম করুন </span> </p>
                                    <p class="text-center" style="font-size: 18px;"> <span class="text-danger">পণ্যের
                                            মূল্যের সাথে ডেলিভারি চার্জ যোগ হবে।</span>
                                    </p>
                                    <p class="text-center" style="font-size: 16px;"> <span class="text-danger">ঢাকা শহরে ৬০
                                            টাকা। সারা বাংলাদেশে ১৫০ টাকা।</span>
                                </header>
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <input type="number" pattern="[0-9]*" id="customerPhone"
                                            placeholder=" আপনার  ১১ সংখ্যাক মোবাইল নম্বর লিখুন" class="form-control">
                                    </div>
                                    <div class="form-group col-sm-12">
                        ...
                        <aside class="card">
                                                ...
                                                @foreach (Cart::content() as $item)
                                                    <tr class="cart-item">
                                                        <td class="product-image"
                                                            ...
                                                            <a href="#">
                                                                <img class="lazyload"
                                                                    src="{{ url('/product/thumbnail/' . $item->model->productImage) }}"
                                                        ...
                                                        <td class="product-quantity">
                                                            <div class="input-group input-spinner">
                                                                <div class="input-group-prepend">
                                                                    <button class="btn btn-light btn-number" type="button"
                                                                        data-type="plus"
                                                                        data-field="quantity[{{ $item->id }}]"> +
                                                                    </button>
                                                                </div>
                                                                <input type="text" name="quantity[{{ $item->id }}]"
                                                                    class="form-control input-number" placeholder="1"
                                                                    value="{{ $item->qty }}" min="1"
                                                                    max="10"
                                                                    onchange="updateQuantity('{{ $item->rowId }}', this)">
                            ...
                            <article class="card-body border-top">
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-4 text-right"><strong class="h5 text-dark">TK
                                            <?php echo Cart::total('0'); ?></strong></dd>
                            ...
                            <p class="text-center" style="font-size: 18px;"> <span class="text-danger">পণ্যের মূল্যের সাথে
                                    ডেলিভারি চার্জ যোগ হবে।</span>
                            </p>
                            <p class="text-center" style="font-size: 16px;"> <span class="text-danger">ঢাকা শহরে ৬০ টাকা।
                                    সারা বাংলাদেশে ১৫০ টাকা।</span>
