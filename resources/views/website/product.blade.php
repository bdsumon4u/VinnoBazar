                            ...
                            <div class="carousel-inner rounded">
                                ...
                                <div class="carousel-item active">
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#lightbox">
                                        <img src="{{ url('/product/' . $product->productImage) }}" alt="First slide"
                            ...
                            <ol class="carousel-indicators">
                                <li data-target="#single-product-galary" data-slide-to="0" class="active">
                                    <img class="img-thumbnail" alt=""
                                        src="{{ url('/product/thumbnail/' . $product->productImage) }}"
                                        url="{{ url('/product/' . $product->productImage) }}">
                                </li>
                                @foreach ($product->media as $media)
                                    <li data-target="#single-product-galary" data-slide-to="{{ $loop->index + 1 }}">
                                        <img class="img-thumbnail" alt=""
                                            src="{{ url('/product/thumbnail/' . $media->url) }}"
                                            url="{{ url('/product/' . $media->url) }}">
                                    </li>
                                @endforeach
                            </ol>
                        </div>
                    ...
                    <div class="col-md-7 border-left">
                        <div class="content-body">
                                ...
                                <div class=" col-md flex-grow-1">
                                    <div class="input-group mb-3 input-spinner">
                                        <div class="input-group-prepend">
                                            <button class="btn btn-light btn-number" type="button" data-type="plus"
                                                data-field="quantity"> + </button>
                                        </div>
                                        <input type="text" class="form-control input-number" value="1"
                                            name="quantity" min="1" max="10">
                                        <div class="input-group-append">
                                            <button class="btn btn-light btn-number" type="button" data-type="minus"
                                                data-field="quantity"> − </button>
                                        </div>
                                    </div>
                                </div> <!-- col.// -->
                            ...
                            <div class="single-product-buttons">
                                ...
                                <button class="btn  btn-danger" onclick="addToCart({{ $product->id }})"> <span
                                        class="text">কার্টে রাখুন</span>
                    ...
                    <div class="tabs tabs--style-2">
                        ...
                        <div class="tab-content pt-0">
                            <div class="tab-pane active show p-2" id="tab_default_1">
                                {{-- @foreach ($product->media as $media)
									<img alt="" src="{{ url('/product/'.$media->url)  }}" style="width: 100%;">
								    <br>
								@endforeach --}}
