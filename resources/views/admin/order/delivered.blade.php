...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-xl-2">
            <a href="{{ url('admin/order/status/Return Received')}}">
                <div class="widget-rounded-circle card-box order pt-1 pb-1">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
                                <h3 class="text-dark mt-1 mb-0">
                                    <span id="returnReceived" data-plugin="counterup">0</span>
                                </h3>
                                <p class="text-muted mb-1 text-truncate">Return Received</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="text-md-right">
                                ...
                                <div class="btn-group dropdown ml-2 float-right">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item btn-change-status" data-status="Return Received" href="#">Return Received</a>
                                    </div>
                                </div>
